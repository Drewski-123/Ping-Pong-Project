...
public static class EventManager
{
    ...
    static List<GameStartingMenu> gameStartedInvokers = new List<GameStartingMenu>();
    static List<UnityAction<GameType, Difficulty>> gameStartedListeners =
        new List<UnityAction<GameType, Difficulty>>();
    ...
    /// </summary>
    /// <param name="invoker">invoker</param>
    public static void AddGameStartedInvoker(GameStartingMenu invoker)
    {
        gameStartedInvokers.Add(invoker);
        foreach (UnityAction<GameType, Difficulty> listener in gameStartedListeners)
        {
    ...
    /// </summary>
    /// <param name="listener">listener</param>
    public static void AddGameStartedListener(UnityAction<GameType, Difficulty> listener)
    {
        gameStartedListeners.Add(listener);
        foreach (GameStartingMenu invoker in gameStartedInvokers)
        {
            invoker.AddGameStartedListener(listener);
        }
    }
