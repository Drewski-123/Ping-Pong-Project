...
public class GameplayManager : MonoBehaviour
{
    ...
    void Awake()
    {
        if (GameUtils.GameType == GameType.OnePlayer)
        {
            GameObject humanPaddle = GameObject.FindGameObjectWithTag("RightPaddle");
            Destroy(humanPaddle);
            Instantiate<GameObject>(prefabComputerPaddle);
        }
    }
